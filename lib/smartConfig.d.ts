...
export declare type ScopeType = 'patient' | 'user' | 'system';
export declare type AccessModifier = 'read' | 'write' | '*';
export declare type IdentityType = 'Patient' | 'Practitioner' | 'Person ' | 'RelatedPerson';
...
export declare type FhirResource = {
    hostname: string;
    resourceType: string;
    id: string;
};
