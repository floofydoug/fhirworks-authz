...
export declare function decodeJwtToken(token: string, expectedAudValue: string | RegExp | string[], expectedIssValue: string): {
    header: import("jsonwebtoken").JwtHeader;
    payload: import("jsonwebtoken").JwtPayload;
    signature: string;
};
export declare function verifyJwtToken(token: string, expectedAudValue: string | RegExp | string[], expectedIssValue: string, client: JwksClient): Promise<string | import("jsonwebtoken").JwtPayload>;
export declare function introspectJwtToken(token: string, expectedAudValue: string | RegExp | string[], expectedIssValue: string, introspectionOptions: IntrospectionOptions): Promise<import("jsonwebtoken").JwtPayload>;
